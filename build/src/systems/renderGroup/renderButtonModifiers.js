    ...
    update(tick, entities) {
        ...
        for (let entity of entities) {
            ...
            if (entity.has("Disabled")) {
                const image = this.ctx.getImageData(entity.Coordinates.X, entity.Coordinates.Y, entity.Renderable.renderW, entity.Renderable.renderH);
                const { data } = image;
                ...
                this.ctx.rect(entity.Coordinates.X - this.ctx.lineWidth, entity.Coordinates.Y - this.ctx.lineWidth, entity.Renderable.renderW + 2 * this.ctx.lineWidth, entity.Renderable.renderH + 2 * this.ctx.lineWidth);
                this.ctx.stroke();
            }
        }
    }
